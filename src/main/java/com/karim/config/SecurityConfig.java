	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	    ...
	    http
	        ...
	        .authorizeHttpRequests(auth -> auth
	            ...
	            // Earnings & payouts
	            .requestMatchers(HttpMethod.POST, "/api/earnings/*/approve",
	                    "/api/earnings/*/dispute",
	                    "/api/earnings/*/incentive",
	                    "/api/earnings/*/penalty",
	                    "/api/earnings/payouts",
	                    "/api/earnings/payouts/*/process",
	                    "/api/earnings/payouts/*/success",
	                    "/api/earnings/payouts/*/fail").hasRole("ADMIN")
	            // Returns admin
	            ...
	            .requestMatchers(HttpMethod.POST, "/api/returns/*/approve",
	                    ...
	                    "/api/returns/*/mark-picked-up",
	                    "/api/returns/*/initiate-refund",
	                    "/api/returns/*/complete").hasRole("ADMIN")
	            // Payments admin
	            .requestMatchers(HttpMethod.POST, "/api/payments/*/success",
	                    "/api/payments/*/fail",
	                    "/api/payments/*/refund").hasRole("ADMIN")
	            .requestMatchers(HttpMethod.POST,
	                    "/api/payments/invoices/*/regenerate").hasRole("ADMIN")
	            ...
	            .requestMatchers(HttpMethod.POST, "/api/delivery/assignments/*/accept",
	                    "/api/delivery/assignments/*/reject",
	                    "/api/delivery/assignments/*/pick-up",
	                    "/api/delivery/assignments/*/in-transit",
	                    "/api/delivery/assignments/*/deliver",
	                    "/api/delivery/assignments/*/fail").hasAnyRole("DELIVERY", "ADMIN")
	            .requestMatchers("/api/delivery/rides/**").hasAnyRole("DELIVERY", "ADMIN")
	            .requestMatchers("/api/tracking/ping/**").hasAnyRole("DELIVERY", "ADMIN")
	            .requestMatchers("/api/earnings/me/**").hasAnyRole("DELIVERY", "ADMIN")
	            .requestMatchers("/api/earnings/payouts/agent/me/**").hasAnyRole("DELIVERY", "ADMIN")
