...
import com.karim.dto.OrderStatusUpdateRequestDto;
...
public class OrderController {
	...
	public ResponseEntity<OrderResponseDto> placeOrder(@RequestHeader("X-User-Id") UUID userId,
	...
	public ResponseEntity<Page<OrderSummaryDto>> listMyOrders(@RequestHeader("X-User-Id") UUID userId,
	...
	public ResponseEntity<OrderResponseDto> getMyOrder(@RequestHeader("X-User-Id") UUID userId,
	...
	public ResponseEntity<List<OrderItemResponseDto>> getMyOrderItems(@RequestHeader("X-User-Id") UUID userId,
			@PathVariable UUID orderId) {
		// ownership validation is covered by getOrder(...)
		orderService.getOrder(orderId, userId);
		return ResponseEntity.ok(orderService.getOrderItems(orderId));
	}

	@PatchMapping("/api/user/orders/{orderId}/cancel")
	public ResponseEntity<Void> cancelMyOrder(@RequestHeader("X-User-Id") UUID userId,
			@RequestHeader(value = "X-Actor-Id", required = false) UUID actorId, @PathVariable UUID orderId,
	...
	@PatchMapping("/api/admin/orders/{orderId}/confirm")
	public ResponseEntity<Void> confirmOrder(@RequestHeader("X-Actor-Id") UUID actorId, @PathVariable UUID orderId) {
		orderService.confirmOrder(orderId, actorId);
		return ResponseEntity.ok().build();
	}

	@PatchMapping("/api/admin/orders/{orderId}/processing")
	public ResponseEntity<Void> markProcessing(@RequestHeader("X-Actor-Id") UUID actorId, @PathVariable UUID orderId) {
		orderService.markProcessing(orderId, actorId);
		return ResponseEntity.ok().build();
	}

	@PatchMapping("/api/admin/orders/{orderId}/dispatch")
	public ResponseEntity<Void> markDispatched(@RequestHeader("X-Actor-Id") UUID actorId, @PathVariable UUID orderId) {
		orderService.markDispatched(orderId, actorId);
		return ResponseEntity.ok().build();
	}

	@PatchMapping("/api/admin/orders/{orderId}/out-for-delivery")
	public ResponseEntity<Void> markOutForDelivery(@RequestHeader("X-Actor-Id") UUID actorId,
			@PathVariable UUID orderId) {
		orderService.markOutForDelivery(orderId, actorId);
		return ResponseEntity.ok().build();
	}

	@PatchMapping("/api/admin/orders/{orderId}/deliver")
	public ResponseEntity<Void> markDelivered(@RequestHeader("X-Actor-Id") UUID actorId, @PathVariable UUID orderId) {
		orderService.markDelivered(orderId, actorId);
		return ResponseEntity.ok().build();
	}

	@PatchMapping("/api/admin/orders/{orderId}/status")
	public ResponseEntity<Void> updateOrderStatus(@RequestHeader("X-Actor-Id") UUID actorId, @PathVariable UUID orderId,
	...
	public ResponseEntity<Void> softDeleteOrder(@RequestHeader("X-Actor-Id") UUID actorId, @PathVariable UUID orderId) {
		orderService.softDeleteOrder(orderId, actorId);
		return ResponseEntity.noContent().build();
	}

	@PatchMapping("/api/admin/order-items/{itemId}/status")
	public ResponseEntity<Void> updateOrderItemStatus(@RequestHeader("X-Actor-Id") UUID actorId,
			@PathVariable UUID itemId, @Valid @RequestBody OrderItemStatusUpdateRequestDto request) {
